...
| [KEM-011](../../docs/adr/ADR-KEM-011-session-bootstrap-endpoint.md) | **ACCEPTED — C.115 in `v0.4.0`.** Repo 2 §4/§18/§56 and Appendix F all require a session bootstrap and no catalog operation returns one; Appendix N never registered it as a delta | Repo 2 A001–A005 unautomatable; T04.01 infers permissions from 403s; forwarding loop check inert |
